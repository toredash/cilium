...
{
	__u8 cluster_id = ctx_load_meta(ctx, CB_CLUSTER_ID_EGRESS) >> 24;
	enum trace_point obs_point;
	int ret;
...
static __always_inline int
__handle_nat_fwd_ipv4(struct __ctx_buff *ctx, __u8 cluster_id __maybe_unused,
		      struct trace_ctx *trace)
{
	int ret;
...
static __always_inline int handle_nat_fwd(struct __ctx_buff *ctx, __u8 cluster_id)
{
	int ret = CTX_ACT_OK;
	__u16 proto;
